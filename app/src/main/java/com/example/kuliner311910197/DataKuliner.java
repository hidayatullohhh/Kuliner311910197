...
public class DataKuliner {
        public static String[][] data = new String[][]{
                ...
                {"Tahu Petis", "Tahu petis adalah jajanan khas kota Semarang berupa tahu goreng yang dimakan dengan petis (saus berwarna hitam kental yang biasanya terbuat dari udang) yang dioleskan/disisipkan di tengah- tengah tahu. Seperti tahu pong tetapi rasanya tidak asin, yaitu berasal dari tahu putih yang digoreng sampai warna kecokelatan tanpa dibumbui atau dibumbui dengan larutan garam dan bawang putih saja.Sedangkan petisnya berasa manis agak sedikit asin. Agar menggugah selera tahu petis biasanya dimakan dengan cabai rawit.",
                        "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Tahu_petis.jpg/800px-Tahu_petis.jpg"},
                {"Dawet", "Dawet merupakan minuman khas Jawa yang terbuat dari tepung beras ataupun tepung beras ketan,disajikan dengan es parut serta gula merah cair dan santan.Rasa minuman ini manis dan gurih.Seiring perkembangan zaman,Es dawet menyebar ke seluruh kota mulai dari Kota Semarang,Solo,Jakarta,Bandung,dan kota lainnya dan memiliki khas masing-masing seperti Dawet Mantingan yang merupakan minuman khas dari kota Jepara",
                        " https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Es_Dawet.jpg/400px-Es_Dawet.jpghttps://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Es_Dawet.jpg/400px-Es_Dawet.jpghttps://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Es_Dawet.jpg/400px-Es_Dawet.jpg"},
                {"Kue Putu", "Kue putu adalah jenis kudapan tradisional Indonesia berupa kue dengan isian gula jawa,dibalut dengan parutan kelapa, dan tepung beras butiran kasar.Kue ini di kukus dengan diletakkan di dalam tabung bambu yang sedikit dipadatkan.Kue ini dijual pada saat matahari terbenam sampai larut malam.Suara khas uap yang keluar dari alat suitan ini sekaligus menjadi alat promosi bagi pedagang yang berjualan." +
